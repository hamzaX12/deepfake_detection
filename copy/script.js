class DeepfakeDetector {
  constructor() {
    ...
    //     description: "Analyzing facial features and temporal consistency",
    //     icon: "fas fa-eye",
    //     progress: 0,
    //     status: "pending",
    //     details: "Examining facial landmarks, lighting, and movement patterns...",
    //     images: [],
    //     currentFrame: 0,
    //   },
      {
  ...
  async startAnalysis() {
    ...
    // Show loading and process details
    ...
    await this.runProcessStep("extract-frames", this.sampleFrames, 25, 150)

    // Step 2: Detect Faces
    await this.runProcessStep("detect-faces", this.sampleFaces, 25, 120)

    // Step 3: Analyze Features
    // await this.runProcessStep("analyze-features", this.sampleAnalysis, 25, 100)
